...
type PageProps = {
  ...
  searchParams: Promise<{ range?: string; adjustmentsRange?: string; activityRange?: string }>;
};
...
export default async function RoleHomePage({ params, searchParams }: PageProps) {
  ...
  const { range: rangeParam, adjustmentsRange: adjustmentsRangeParam, activityRange: activityRangeParam } = await searchParams;
        ...
        <section className="grid gap-4 xl:grid-cols-12">
          <div className="space-y-2 xl:col-span-6">
            <RangeSwitch
              ...
              preserve={{ activityRange: String(activityRange) }}
              label="Lapso ajustes"
            />
            <TopAdjustmentsChart
          ...
          <div className="space-y-2 xl:col-span-6">
            <RangeSwitch
              ...
              preserve={{ adjustmentsRange: String(adjustmentsRange) }}
  ...
  return (
    <div className="mx-auto flex w-full max-w-7xl flex-col gap-4">
      ...
      <RangeSwitch role={profileRole} current={range} options={rangeOptions} />
