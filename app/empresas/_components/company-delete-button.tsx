      ...
      {isOpen ? (
        <div className="fixed inset-0 z-40 flex items-center justify-center bg-black/30 p-4">
          <div className="w-full max-w-md rounded-[12px] border border-[var(--border)] bg-white p-4">
            <h3 className="text-[16px] font-semibold text-foreground">Eliminar empresa</h3>
            <p className="mt-2 text-[13px] text-[var(--muted)]">
              Escribe exactamente el nombre de la empresa para confirmar:
            </p>
            ...
            <form action={formAction} className="mt-3 space-y-3">
              ...
              <input type="hidden" name="expectedName" value={companyName} />
              ...
              <div className="flex justify-end gap-2">
                ...
                <button
                  type="submit"
                  disabled={isPending || typedName !== companyName}
